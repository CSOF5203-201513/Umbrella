...
@NamedQueries({
    ...
    @NamedQuery(name = "EpisodioMigrana.findBetween", query = "SELECT e FROM EpisodioMigrana e WHERE e.fechacreacion between :fechainicio and :fechafin AND e.idpaciente = :idpaciente"),
