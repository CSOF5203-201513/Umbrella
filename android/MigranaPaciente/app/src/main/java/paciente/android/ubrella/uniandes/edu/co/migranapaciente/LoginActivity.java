...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public void attemptLogin() {
        ...
        String identification = mEmailView.getText().toString();
        ...
        if (TextUtils.isEmpty(identification)) {
            ...
            cancel = true;
        } else if (!isIDValid(identification)) {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(identification, password);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, User> {
        ...
        @Override
        protected void onPostExecute(final User authenticatedUser) {
            mAuthTask = null;
            showProgress(false);
